const registrationTemplate = (name: string, email: string, affiliation: string, university: string) => `
...
<p style="font-size: 16px; margin: 0; padding: 10px 20px;">They said they are from ${university} and affiliated as follows: ${affiliation}</p>
	`
