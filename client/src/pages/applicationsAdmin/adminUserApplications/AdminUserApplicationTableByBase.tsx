...
const BaseApplicationTableByBase: React.FC<RouteComponentProps> = () => {
  const context = React.useContext(AdminUserApplicationContextByBase)
  ...
  return (
    <div>
      <TableHeader>
        ...
        />
        <BaseApplicationHeading>User Applications By Base</BaseApplicationHeading>
      </TableHeader>
...
export default BaseApplicationTableByBase
